  ...
  const menuList = [
    {
      title: '홈',
      to: '/',
      icon: <Icon name="home" className={iconStyle} />,
    },
    {
      title: '일기',
      to: '/diary',
      icon: <Icon name="book" className={iconStyle} />,
    },
    {
      title: '친구',
      to: '/friends',
      icon: <Icon name="friend" className={iconStyle} />,
    },
    {
      title: '내 정보',
      to: '/mypage',
      icon: <Icon name="profile" className={iconStyle} />,
    },
  ];
